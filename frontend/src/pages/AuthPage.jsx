...
const AuthPage = () => {
  ...
  useEffect(() => {
    if (bannerRef.current && formRef.current) {
      if (isLogin) {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 py-12 px-4 sm:px-6 lg:px-8 overflow-hidden">
      <div className="max-w-4xl w-full">
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden">
          {/* Main container with proper overflow handling */}
          <div className="flex flex-col md:flex-row relative h-[700px] md:h-[600px] overflow-hidden">
            {/* Banner/Info Section */}
            <div
              ref={bannerRef}
              className="absolute md:relative w-full md:w-1/2 h-full p-8 flex flex-col justify-between transition-transform duration-700 ease-in-out"
              style={{
                background: isLogin
            ...
            >
              <div className="overflow-hidden">
                ...
                <div
                  className={`text-white transition-opacity duration-500 ${
                    isLogin ? "opacity-100" : "opacity-0 absolute inset-0 p-8"
                  }`}
                >
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center">
                      ...
                      <span>Generate payment requests instantly</span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center mr-3">
                        <svg
                ...
                >
                  ...
                  <p className="mb-6 opacity-90">
                    ...
                    management and access powerful analytics.
                  </p>
                  <div className="space-y-4">
                    <div className="flex items-center">
                      <div className="w-8 h-8 rounded-full bg-white/20 flex items-center justify-center mr-3">
              ...
              <div className="text-center">
                <p className="text-white/80 text-sm">
                  © {new Date().getFullYear()} School Payment Dashboard. All
                  rights reserved.
                </p>
              </div>
            </div>
            ...
            <div
              ref={formRef}
              className="w-full md:w-1/2 h-full p-8 md:p-12 overflow-y-auto overflow-x-hidden transition-transform duration-700 ease-in-out"
              style={{
                left: 0,
                top: 0,
              }}
